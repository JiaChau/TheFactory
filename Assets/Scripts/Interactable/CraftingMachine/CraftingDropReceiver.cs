...
public class CraftingDropReceiver : MonoBehaviour, IDropReceiver
{
    //essentially this transform is the "slot" or image itself 
    //optimized later
    public Transform machineSlot;
    ...
    public void HandleItemDrop(ItemData itemData, int amount)
    {
        ...
        if (itemData != null)
        {
            MachineInventoryManager.Instance.inventory.AddItem(itemData, amount);
            ...
            //GameObject itemUI = Instantiate(itemUIPrefab, machineSlot);
            ...
            //dragItem.parentAfterDrag = machineSlot;
